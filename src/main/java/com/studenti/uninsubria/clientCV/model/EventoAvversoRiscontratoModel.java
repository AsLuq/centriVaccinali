 ...
 * author luqmanasghar
 */
public class EventoAvversoRiscontratoModel {
    private int idEventoAvversoRiscontrato;
    ...
    public String toString() {
        return "EventoAvversoRiscontratoModel{" +
                "idEventoAvversoRiscontrato=" + idEventoAvversoRiscontrato +
                ", severita=" + severita +
