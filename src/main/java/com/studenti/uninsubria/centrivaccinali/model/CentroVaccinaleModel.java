...
public class CentroVaccinaleModel {
    ...
    public CentroVaccinaleModel(int idCentroVaccinale, String nome, String provincia, String comune, String via, String cap) {
    ...
    public String toString() {
        return "CentroVaccinaleModel{" +
                "idCentroVaccinale=" + idCentroVaccinale +
                ", nome='" + nome + '\'' +
                ", provincia='" + provincia + '\'' +
                ", comune='" + comune + '\'' +
                ", via='" + via + '\'' +
